...
if (!class_exists('AcordTravel_Client')) {
  require_once __DIR__ . '/autoload.php';
}

/**
 * Extension to the regular AcordTravel_Model that automatically
 * exposes the items array for iteration, so you can just
 * iterate over the object rather than a reference inside.
 */
class AcordTravel_Collection extends AcordTravel_Model implements Iterator, Countable
{
